    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrador'), ('TEACHER', 'Docente'), ('STUDENT', 'Estudiante')], default='STUDENT', help_text='Rol del usuario en el sistema', max_length=10, verbose_name='Rol')),
                ('phone', models.CharField(blank=True, help_text='Número de teléfono de contacto', max_length=15, null=True, verbose_name='Teléfono')),
                ...
                ('date_of_birth', models.DateField(blank=True, help_text='Fecha de nacimiento del usuario', null=True, verbose_name='Fecha de nacimiento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, help_text='Biografía o descripción del usuario', verbose_name='Biografía')),
                ('address', models.CharField(blank=True, help_text='Dirección de residencia', max_length=255, verbose_name='Dirección')),
                ('city', models.CharField(blank=True, help_text='Ciudad de residencia', max_length=100, verbose_name='Ciudad')),
                ('country', models.CharField(default='Colombia', help_text='País de residencia', max_length=100, verbose_name='País')),
