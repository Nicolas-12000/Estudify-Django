...
urlpatterns = [
    ...
    path(
        'courses/<int:pk>/edit/',
        views_admin.course_edit,
        name='course_edit'),
    path(
        'courses/<int:pk>/delete/',
        views_admin.course_delete,
        name='course_delete'),
    ...
    path(
        'subjects/create/',
        views_admin.subject_create,
        name='subject_create'),
    path(
        'subjects/<int:pk>/edit/',
        views_admin.subject_edit,
        name='subject_edit'),
    path(
        'subjects/<int:pk>/delete/',
        views_admin.subject_delete,
        name='subject_delete'),
    ...
    path(
        'enrollments/create/',
        views_admin.enrollment_create,
        name='enrollment_create'),
    path(
        'enrollments/<int:pk>/delete/',
        views_admin.enrollment_delete,
