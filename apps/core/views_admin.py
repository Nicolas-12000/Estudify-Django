...
from apps.courses.forms import CourseForm, SubjectForm, CourseEnrollmentForm
from apps.academics.forms import GradeForm, AttendanceForm
...
def user_create(request):
    ...
    return render(request, 'admin_panel/user_form.html', {'form': form, 'action': 'Crear'})
...
def course_create(request):
    ...
    return render(request, 'admin_panel/course_form.html', {'form': form, 'action': 'Crear'})
...
def course_edit(request, pk):
    ...
    return render(request, 'admin_panel/course_form.html', {'form': form, 'action': 'Editar', 'course': course})
...
def subject_list(request):
    ...
    subjects = Subject.objects.all().select_related('course', 'teacher').order_by('course', 'name')
...
def subject_create(request):
    ...
    return render(request, 'admin_panel/subject_form.html', {'form': form, 'action': 'Crear'})
...
def subject_edit(request, pk):
    ...
    return render(request, 'admin_panel/subject_form.html', {'form': form, 'action': 'Editar', 'subject': subject})
...
def enrollment_create(request):
    ...
    return render(request, 'admin_panel/enrollment_form.html', {'form': form, 'action': 'Crear'})
...
def enrollment_delete(request, pk):
    ...
    return render(request, 'admin_panel/enrollment_confirm_delete.html', {'enrollment': enrollment})
