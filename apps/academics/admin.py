...
class GradeAdmin(admin.ModelAdmin):
	list_display = ['student', 'subject', 'value', 'grade_type', 'weight', 'is_passing', 'letter_grade', 'graded_date']
	...
	fieldsets = (
		(_('Calificación'), {'fields': ('student', 'subject', 'value', 'grade_type', 'weight')}),
		(_('Detalles'), {'fields': ('comments', 'graded_by')}),
		(_('Estado'), {'fields': ('is_active', 'graded_date', 'created_at')}),
	)
...
class AttendanceAdmin(admin.ModelAdmin):
	list_display = ['student', 'course', 'date', 'status', 'recorded_by', 'is_active']
	...
	def mark_as_present(self, request, queryset):
		...
		self.message_user(request, f'{count} registros marcados como presente.')
